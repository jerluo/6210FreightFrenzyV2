...
@Config
@Autonomous(name = "Red Warehouse Normal", group = "red")
public class RedWarehouseNormal extends LinearOpMode {
    ...
    public static double depotAng = 100; // Degrees

    // PARK TRAJECTORY
    public static double parkX = 55;
    public static double parkY = -71;
    public static double parkAng = 170; // Degrees
