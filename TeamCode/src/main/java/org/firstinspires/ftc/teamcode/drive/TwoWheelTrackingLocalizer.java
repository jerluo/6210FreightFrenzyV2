...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_Y = 4.55729; // Y is the strafe direction

    public static double PERPENDICULAR_X = -2;
    public static double PERPENDICULAR_Y = 0;

    public static double X_MULTIPLIER = 1.02919987;
    public static double Y_MULTIPLIER = 1.03155817;
