...
public class RedCloseAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        // Start doing vision
        int pos = vuforia.redCarouselPosition();
        ...
        Trajectory trajectory1 = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-63.5, -64.5, Math.toRadians(248)))
                .build();
        ...
        if (pos == 1) {
            trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                    .lineToLinearHeading(new Pose2d(-11.3, -58, Math.toRadians(98.5)))
                    .build();
        } else if (pos == 2) {
            trajectory2 = drive.trajectoryBuilder(trajectory1.end())
